            ...
            return (
              <th
                ...
                className={`cursor-pointer
                            ...
                            ${isNav ? 'pt-2 pb-1.5 w-1/5 first:pl-2 last:pr-2 text-[#a4a4a4] text-[12px] bg-white tracking-tighter before:content-[""] before:absolute before:top-0 before:left-0 before:w-full before:border-b before:border-l before:border-solid after:content-[""] after:absolute after:bottom-0 after:left-0 after:w-full after:border-t after:border-solid' : 'pt-4 pb-4 bg-[#f8f9fa] border-b-2 border-white'}
                          `}
              >
